...
A two-factor mixed repeated-measures ANOVA was done. Device was considered a between-subject factor and session as a within-subject factor. The ANOVA model includes an Error term to account for repeated measurements within participants: 
